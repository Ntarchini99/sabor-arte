    ...
    <div className="max-w-[1640px] mx-auto p-4 ">
      <div className="max-h-[700px] relative ">
        <div className="absolute w-full h-full text-gray-200 max-h-[700px] bg-black/40 flex flex-col justify-center z-10">
          <h1 className="px-4 text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold">Las <span className="text-orange-500">Mejores</span></h1>
          <h1 className="px-4 text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-orange-500">comidas <span className="text-gray-200">de Argentina</span></h1>
        </div>
